...
export const caseCommentsArticle: DocArticle = {
  ...
  sections: [
    section("write", "Написать комментарий", steps(
      ["Откройте обсуждение", "В карточке тест-кейса найдите раздел **Комментарии** (Comments) с открытым Markdown-редактором. Панель форматирования и поле ввода всегда доступны."],
