...
export const writingAssistantArticle: DocArticle = {
  ...
  keywords: ["Falcon AI", "исправить ошибки", "улучшить текст", "Markdown", "маркер", "цвет", "выделение", "сфера", "highlight", "writing", "improve", "English"],
  ...
  sections: [
    ...
    section("marker", "Отметьте важное цветом", steps(
      ...
      ["Выберите цвет", "Доступны жёлтый, голубой, зелёный, розовый и лиловый. Полупрозрачный штрих сочетается с жирным текстом, ссылками и другим форматированием."],
    ...
    section("english-marker", "English · Colored highlights", bullets(
      ...
      "Highlights persist when the field is saved and reopened. Select marked text and choose **Remove highlight** to clear it."),
