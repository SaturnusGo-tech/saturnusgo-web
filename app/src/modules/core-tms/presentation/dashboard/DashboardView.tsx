  ...
  const metrics = [
    {
      ...
      icon: <FileCheck2 size={18} />, tone: "metricNeutral",
    },
    {
  ...
  return (
    <div className={`${styles.pageScroll} ${surface.page}`}>
      <header className={surface.header}>
        ...
        <div className={surface.rangeRow}>
      ...
      <section className={surface.ledger} aria-label={t("dashboard.summaryAria")}>
        {metrics.map((metric) => (
          <article className={`${surface.metric} ${surface[metric.tone]}`} key={metric.label}>
