...
const en = {
  ...
  archiveHint: "The portfolio and its projects will move to the archive. Test cases, runs and history are preserved.",
...
const ru: typeof en = {
  ...
  archiveHint: "Портфель и его проекты переместятся в архив. Тест-кейсы, прогоны и история сохранятся.",
