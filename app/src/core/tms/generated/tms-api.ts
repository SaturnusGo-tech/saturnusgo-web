...
export interface paths {
    ...
    "/notifications": {
        ...
        /** List personal notification read state and workspace events */
    ...
    "/notifications/settings": {
        ...
        /** Get the current member notification channels */
        ...
        head?: never;
        /**
         * Choose notification categories and language
    ...
    "/notifications/{id}/read": {
        ...
        put?: never;
        /**
         * Mark a notification read for the current member
         * @description Per-member state replacement or single current challenge. Unique database keys make repeated destination registration and read marking converge.
         */
    ...
    "/notifications/browser": {
        ...
        put?: never;
        /**
         * Connect an encrypted browser push subscription
         * @description Per-member state replacement or single current challenge. Unique database keys make repeated destination registration and read marking converge.
         */
        post: operations["connectBrowserNotifications"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/notifications/telegram/link": {
        ...
        put?: never;
        /**
         * Issue a ten minute Telegram linking challenge
         * @description Per-member state replacement or single current challenge. Unique database keys make repeated destination registration and read marking converge.
         */
        post: operations["linkTelegramNotifications"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/notifications/telegram/confirm": {
        parameters: {
            query?: never;
            header?: {
                /** @description Optional caller correlation ID. The server validates its safe character/length policy or generates a new value, and always returns the effective ID. */
        ...
        put?: never;
        /**
         * Confirm the private Telegram account in the authenticated Falcon session
         * @description Per-member state replacement or single current challenge. Unique database keys make repeated destination registration and read marking converge.
         */
        post: operations["confirmTelegramNotifications"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/notifications/disconnect": {
        ...
        put?: never;
        /**
         * Disable the current member notification destination
         * @description Per-member state replacement or single current challenge. Unique database keys make repeated destination registration and read marking converge.
         */
        post: operations["disconnectNotifications"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        NotificationDisconnect: {
            ...
            destinationId?: components["schemas"]["Identifier"];
        };
        NotificationPage: {
        ...
        NotificationBrowserResponse: {
            data: {
                id: components["schemas"]["Identifier"];
            };
        };
        NotificationTelegramLinkResponse: {
            data: {
                /** Format: uri */
                url: string;
                /** @constant */
        ...
        ImportInspectResponse: {
            data: {
                records: components["schemas"]["ImportSourceRecord"][];
                selectors: string[];
            };
        };
        ImportNormalizeRequest: {
            projectId: components["schemas"]["Identifier"];
            /** @enum {string} */
            locale: "ru" | "en";
            folders: string[];
        ...
        ImportNormalizedCase: {
            sourcePath: string;
            folderPath: string;
            content: components["schemas"]["ImportNormalizedContent"];
            warnings: ("INCOMPLETE_STEPS" | "SOURCE_FIELDS_PRESERVED" | "NO_COMPLETE_PROCEDURE")[];
        };
        ImportNormalizationIssue: {
            sourcePath: string;
            /** @enum {string} */
            code: "IMPORT_SOURCE_INVALID" | "IMPORT_MAPPING_INVALID" | "IMPORT_LIMIT_EXCEEDED" | "IMPORT_AI_UNAVAILABLE";
        };
...
export interface operations {
    ...
    connectBrowserNotifications: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["NotificationBrowserSubscription"];
            };
        };
        responses: {
            /** @description Success */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["NotificationBrowserResponse"];
                };
            };
            400: components["responses"]["BadRequest"];
            401: components["responses"]["Unauthorized"];
    ...
    linkTelegramNotifications: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["NotificationTelegramLinkResponse"];
                };
            };
            400: components["responses"]["BadRequest"];
            401: components["responses"]["Unauthorized"];
    ...
    disconnectNotifications: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["NotificationDisconnect"];
            };
        };
        responses: {
            /** @description Success */
    ...
    inspectExternalTestCaseImport: {
        ...
        responses: {
            ...
            401: components["responses"]["Unauthorized"];
            403: components["responses"]["Forbidden"];
            /** @description Source or model mapping is invalid; no product records are created */
            422: {
                headers: {
                    "X-Request-Id": components["headers"]["XRequestId"];
                    [name: string]: unknown;
            ...
            500: components["responses"]["InternalError"];
            /** @description AI provider unavailable or configured request budget exhausted */
            503: {
                headers: {
                    "X-Request-Id": components["headers"]["XRequestId"];
                    [name: string]: unknown;
    ...
    normalizeExternalTestCaseImport: {
        parameters: {
            query?: never;
            header?: {
                /** @description Optional caller correlation ID. The server validates its safe character/length policy or generates a new value, and always returns the effective ID. */
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ImportNormalizeRequest"];
            };
        };
        responses: {
            /** @description Success */
    ...
    createSupportRequest: {
        ...
        responses: {
            ...
            404: components["responses"]["NotFound"];
            409: components["responses"]["Conflict"];
            /** @description The unsubmitted support draft expired. */
            410: {
                headers: {
                    "X-Request-Id": components["headers"]["XRequestId"];
                    [name: string]: unknown;
            ...
            /** @description The support request budget was exhausted. Try again later. */
            429: {
                headers: {
                    "X-Request-Id": components["headers"]["XRequestId"];
                    [name: string]: unknown;
