...
test("verifies reviewed Pages evidence, required routes and their runtime assets over HTTPS", async () => {
  ...
  assert.ok(result.checkedAssets.includes("/falcon/landing/2026-09/youtrack-workflow.mp4"));
  assert.ok(result.checkedAssets.includes("/falcon/landing/2026-09/youtrack-workflow.vtt"));
